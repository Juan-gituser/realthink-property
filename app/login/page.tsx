      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-primary text-white p-12 flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg space-y-6">
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            Akses kalkulator finansial properti eksklusif, rekomendasi berbasis AI, dan manajemen portofolio investasi dalam satu genggaman.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        ...
        >
          ...
          <p className="text-center text-xs text-muted-foreground pt-2">
            ...
            <Link href="/daftar" className="font-semibold text-secondary hover:underline">
              Daftar gratis
            </Link>
          </p>
        </motion.div>
